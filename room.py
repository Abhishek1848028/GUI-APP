...
class room_window:
    ...
    def __init__(self,root):
        ...
        #======================LEVEL===================
        lbl_title=Label(self.root,text="ROOMS",font=("times new roman",15,"bold"),bg="black",fg="gold",bd=4,relief=RIDGE)
        ...
        #=================== lavel frame====================
        levelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="House Owner Detail",font=("times new roman",12,"bold"),padx=2)
        levelframeleft.place(x=5,y=50,width=425,height=490)

        #============ lavels and entrys========================
        #owner_id
        lbl_cust_id=Label(levelframeleft,text="Owner ID",font=("times new roman",12,"bold"),padx=2,pady=2)
        ...
        #building detail
        lbl_address=Label(levelframeleft,text="Building detail",font=("times new roman",12,"bold"),padx=2,pady=2)
        ...
        #guly no detail
        lbl_local=Label(levelframeleft,text="Gully No Detail",font=("times new roman",12,"bold"),padx=2,pady=2)
        ...
        #colony
        lbl_localphone=Label(levelframeleft,text="Colony",font=("times new roman",12,"bold"),padx=2,pady=2)
        ...
        #area
        lbl_area1=Label(levelframeleft,text="Area",font=("times new roman",12,"bold"),padx=2,pady=2)
        ...
        #district
        lbl_area2=Label(levelframeleft,text="District",font=("times new roman",12,"bold"),padx=2,pady=2)
        ...
        #pincode
        lbl_area3=Label(levelframeleft,text="Pin code",font=("times new roman",12,"bold"),padx=2,pady=2)
        ...
        #expected rent
        lbl_rent=Label(levelroomdetail,text="Minimum Rent",font=("times new roman",12,"bold"),padx=2,pady=2)
        ...
        combo_rent.grid(row=2,column=1)
         ...
         #no of person
        lbl_person=Label(levelroomdetail,text="maximum Persons allow",font=("times new roman",10,"bold"),padx=2,pady=2)
        ...
        combo_search["values"]=("Select","mobile","c_id","adhar","parea1")
        ...
        self.Cust_Details_table.heading("c_id",text="OWNER ID")
        ...
        self.Cust_Details_table.heading("nation",text="Building Detail")
        self.Cust_Details_table.heading("local_person",text="Gully no dtail")
        self.Cust_Details_table.heading("person_con",text="colony")
        self.Cust_Details_table.heading("parea1",text="Area")
        self.Cust_Details_table.heading("parea2",text="District")
        self.Cust_Details_table.heading("parea3",text="Pin code")
        ...
        self.Cust_Details_table.heading("rent",text="Minimum Rent")
    ...
    def add_data(self):
        if self.var_mobile.get()=="" or self.var_c_id.get()=="" or self.var_name.get()=="" or self.var_gender.get()=="Select" or self.var_room_type.get()=="Select" or self.var_no_of_rooms.get()=="Select" or self.var_kitchen.get()=="Select" or self.var_att_wash.get()=="Select" or self.var_rent.get()=="Select" or self.var_no_of_person.get()=="Select" or self.var_deposite.get()=="Select":
            messagebox.showerror("Error","All fields are required",parent=self.root)
        else:
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='Abhi@2127',database="room_finding_gui")
                my_cursor=conn.cursor()
                my_cursor.execute("insert into room values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
                                                self.var_c_id.get(),
                                                self.var_name.get(),
                                                self.var_gender.get(),
                                                self.var_mobile.get(),
    ...
    def update(self):
        if self.var_mobile.get() == "":
            ...
            conn = mysql.connector.connect(host='localhost', username='root', password='Abhi@2127', database="room_finding_gui")
            my_cursor = conn.cursor()
            my_cursor.execute("UPDATE room SET name=%s, gender=%s, mobile=%s, email=%s, adhar=%s, `addr`=%s, regi_time=%s, nation=%s, local_person=%s, person_con=%s, parea1=%s, parea2=%s, parea3=%s, room_type=%s, no_of_rooms=%s, kitchen=%s, att_wash=%s, rent=%s, no_of_person=%s, deposite=%s, other_remark=%s WHERE c_id=%s", (
                self.var_name.get(),
                self.var_gender.get(),
                self.var_mobile.get(),
                self.var_email.get(),
    ...
    def mdelete(self):
        ...
        if mdelete>0:
            conn=mysql.connector.connect(host='localhost', username='root', password='Abhi@2127', database="room_finding_gui")
            my_cursor=conn.cursor()
            query="delete from room where c_id=%s"
